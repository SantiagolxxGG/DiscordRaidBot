...
if (!fs.existsSync('config.json')) {
    fs.writeFileSync('config.json', JSON.stringify({
        "nombreCanales": "Yoy puto",
        "cantidadCanales": 100,
        "mensajesPorCanal": 100,
        "mensajeRepetido": "yoy puto"
    }, null, 4));
...
const token = 'MTI5NTEwMTM2NzM3MDc4MDcwMg.Gfx8H_.ow60fueKGcQrUBXlb39pHGb3o_o04A4ZL_gCQE'; // Reemplaza esto con tu token de bot
